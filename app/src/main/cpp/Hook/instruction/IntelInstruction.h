...
#ifndef FAINHOOK_INTELINSTRUCTION_H
#define FAINHOOK_INTELINSTRUCTION_H
...
class IntelInstruction : public Instruction {
public:
    ~IntelInstruction() {}
...
private:
    ...
    _disused static void MSWriteSkip(uint8_t *&current, size_t size) {
...
#endif //FAINHOOK_INTELINSTRUCTION_H
